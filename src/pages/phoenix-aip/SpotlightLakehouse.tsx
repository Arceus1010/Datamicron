...
export default function SpotlightLakehouse() {
            ...
            <motion.div className="flex flex-col gap-8" variants={stagger()} initial="hidden" animate="show">
              <motion.div variants={fadeUp} transition={{ duration: 0.5, ease: EASE }} className="flex items-center gap-2.5">
                ...
                <span className="text-sm font-semibold text-cyan-400 uppercase tracking-widest">
                  Phoenix AIP — Spotlight Lakehouse
                </span>
              </motion.div>
              ...
              >
                Spotlight Lakehouse brings all your structured and unstructured data into a single, AI-ready platform — secure, governed, and built for scale.
              </motion.p>
            ...
            >
              <div className="bg-brand-navy rounded-2xl p-8 flex flex-col gap-6 border border-brand-navy-border">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white font-semibold">Spotlight Lakehouse unifies everything</span>
                </div>
                <p className="text-white/60 leading-relaxed text-sm">
                  Fragmented data costs enterprises in missed AI opportunities, duplicated infrastructure, and inconsistent governance. Spotlight Lakehouse brings it all together — one platform, one truth, governed from the start.
                </p>
            ...
            >
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex-1 rounded-xl border border-brand/30 bg-brand-light p-4 text-center">
                  <p className="text-xs font-semibold text-brand uppercase tracking-widest mb-1.5">Spotlight Lakehouse</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            >
              ...
              <motion.p variants={fadeUp} transition={{ duration: 0.55, ease: EASE }} className="text-gray-500 leading-relaxed">
                Most data platforms force a trade-off between flexibility and governance. Spotlight Lakehouse was designed so you never have to choose — every dataset is open, structured, secured, and AI-ready from the moment it lands.
              </motion.p>
        ...
        <div className="max-w-6xl mx-auto px-6 py-24 flex flex-col items-center text-center">
          ...
          >
            ...
            <motion.p variants={fadeUp} transition={{ duration: 0.6, ease: EASE }} className="text-lg text-white/55 leading-relaxed">
              See Spotlight Lakehouse consolidate your data estate into a single, governed, AI-ready platform — in a live demo tailored to your stack.
            </motion.p>
