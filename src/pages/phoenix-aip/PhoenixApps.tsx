...
const HOW_IT_WORKS = [
  {
    step: '01',
    label: 'Connect',
    description: 'Point an app at governed data already flowing through DataForge and Spotlight Lakehouse — no new integrations, no duplicated pipelines, no shadow copies of your data.',
...
function AppComposerVisual() {
  return (
    <div className="relative w-full max-w-md">
      ...
      >
        {['Cortexus', 'Phoenix Insights', 'Spotlight Lakehouse', 'DataForge'].map((item) => (
...
export default function PhoenixApps() {
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <motion.div className="flex flex-col gap-8" variants={stagger()} initial="hidden" animate="show">
              ...
              >
                PhoenixApps lets your teams compose governed, AI-native business applications on top of Phoenix AIP — in weeks, not quarters, and without a bespoke build for every idea.
              </motion.p>
            ...
            >
              <div className="bg-brand-navy rounded-2xl p-8 flex flex-col gap-6 border border-brand-navy-border">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white font-semibold">PhoenixApps closes the last mile</span>
                </div>
                <p className="text-white/60 leading-relaxed text-sm">
                  An insight that never reaches the person doing the work changes nothing. PhoenixApps puts the data, the reasoning, and the action in one place — the screen your team already lives in — so decisions turn into outcomes the same day.
                </p>
        ...
        <div className="max-w-4xl mx-auto px-6 py-24 text-center">
          ...
          >
            ...
            <motion.p variants={fadeUp} transition={{ duration: 0.6, ease: EASE }} className="text-xl text-gray-500 leading-relaxed max-w-2xl">
              PhoenixApps is where governed data, AI reasoning, and autonomous agents are assembled into the everyday applications your teams work in — built once on Phoenix AIP, deployed everywhere.
            </motion.p>
            ...
            <motion.div variants={fadeUp} transition={{ duration: 0.6, ease: EASE }} className="mt-6 w-full max-w-2xl">
              <div className="flex items-center gap-3">
                {[
                  ...
                  { label: 'PhoenixApps', sub: 'Compose · Automate · Deploy', color: 'bg-indigo-50 border-indigo-300 text-indigo-700', sub_color: 'text-indigo-500', highlight: true },
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            >
              ...
              <motion.p variants={fadeUp} transition={{ duration: 0.55, ease: EASE }} className="text-gray-500 leading-relaxed">
                Generic low-code tools hand you an empty canvas and leave the data, the AI, and the governance to you. PhoenixApps starts from a platform that already has all three — so every app you build inherits governed data, live reasoning, and enterprise controls on day one.
              </motion.p>
              ...
              <motion.div variants={fadeUp} transition={{ duration: 0.55, ease: EASE }} className="mt-2 bg-gray-50 rounded-2xl p-6 border border-gray-100 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3">
                  {[
                    ...
                    { label: 'Spotlight Lakehouse', sub: 'The governed data every app reads and writes' },
        ...
        <div className="max-w-6xl mx-auto px-6 py-24 flex flex-col items-center text-center">
          ...
          >
            ...
            <motion.p variants={fadeUp} transition={{ duration: 0.6, ease: EASE }} className="text-lg text-white/55 leading-relaxed">
              See PhoenixApps compose a governed, AI-native application on your own data — in a live demo built around a workflow your team runs today.
            </motion.p>
