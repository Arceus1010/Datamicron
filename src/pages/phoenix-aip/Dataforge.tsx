...
const CAPABILITIES = [
  {
    ...
    description:
      'Stream data from any source — databases, SaaS platforms, IoT devices, event queues — with native support for both real-time streaming and high-volume batch loads.',
    points: [
  ...
  },
  {
    ...
    description:
      'Clean, normalise, and structure raw data through flexible, code-or-config transformation pipelines that handle even the most complex multi-step workflows.',
    points: [
      'Schema normalisation & mapping',
      'Complex multi-step pipelines',
      'Code or low-code transformation',
    ],
  },
  {
    id: 'quality',
    ...
    description:
      'Automatically validate, cleanse, and enrich every record with internal and external sources — ensuring every downstream AI model and dashboard works from reliable data.',
    points: [
      'Automated validation & cleansing',
      'Internal + external enrichment',
      'AI-ready dataset guarantees',
    ],
  },
  {
    id: 'apis',
    ...
    description:
      'Expose clean, transformed data via APIs and build reusable, production-grade pipelines that integrate seamlessly with every downstream system in your stack.',
    points: [
      'Data API exposure layer',
      'Reusable, versioned pipelines',
      'Plug-in ecosystem integrations',
    ],
  },
]
...
const HOW_IT_WORKS = [
  {
    ...
    label: 'Connect',
    description:
      'DataForge connects to your existing data sources — cloud databases, SaaS tools, streaming platforms, on-premise systems, and custom APIs — with no rip-and-replace.',
  ...
  },
  {
    ...
    label: 'Ingest',
    description:
      'Data is captured continuously in real time or loaded in optimised batch windows — with automatic schema detection, deduplication, and error handling built in.',
  ...
  },
  {
    ...
    label: 'Transform',
    description:
      'Raw records flow through configurable transformation stages — cleaned, normalised, enriched, and validated against quality rules before they touch any downstream system.',
  ...
  },
  {
    ...
    label: 'Deliver',
    description:
      'Clean, high-quality data is routed to Spotlight Data Fabrics, Phoenix Insights, Cortexus, or any application — in the format and frequency each consumer needs.',
...
const USE_CASES = [
  {
    ...
    items: [
      ...
      'Operational insights with no lag',
  ...
  },
  {
    ...
    items: [
      'Prepare datasets for ML and LLMs',
      'Continuous pipelines for training & inference',
  ...
  },
  {
    ...
    items: [
      'Replace brittle legacy data pipelines',
      'Simplify complex data workflows',
      'Cut pipeline maintenance overhead',
    ],
  },
  {
    icon: (
    ...
    items: [
      'Unify SaaS, databases, and APIs',
      'Seamless cross-system data flow',
      'Single integration layer for all tools',
    ],
  },
]
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              >
                DataForge ingests, transforms, and activates your data at scale — delivering
                high-quality, real-time pipelines ready for AI and analytics.
              </motion.p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <motion.span
                variants={fadeUp}
                transition={{ duration: 0.5, ease: EASE }}
                className="text-sm font-semibold text-emerald-700 uppercase tracking-widest"
              >
                The Problem
              </motion.span>
              <motion.h2
              ...
              <div className="bg-brand-navy rounded-2xl p-8 flex flex-col gap-6 border border-brand-navy-border">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white font-semibold">
                    DataForge turns raw data into a reliable asset
                  </span>
                </div>
                <p className="text-white/60 leading-relaxed text-sm">
                  Every broken pipeline, every bad record, every delayed dataset costs your
                  organisation in wrong decisions, stalled AI initiatives, and wasted engineering
                  hours. DataForge removes the friction — permanently.
                </p>
      ...
      <section className="bg-white">
        <div className="max-w-4xl mx-auto px-6 py-24 text-center">
          ...
          >
            ...
            >
              A data engineering platform built for{' '}
              <span className="text-emerald-600">real-time activation.</span>
            </motion.h2>
            <motion.p
              variants={fadeUp}
              transition={{ duration: 0.6, ease: EASE }}
            ...
            >
              DataForge enables real-time ingestion, transformation, enrichment, and delivery of
              data across your entire ecosystem — so every downstream system always works from
              clean, reliable data.
            </motion.p>
            ...
            >
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                {[
                  {
                    label: 'Raw Data',
                    sub: 'Fragmented, inconsistent',
                    color: 'bg-red-50 border-red-200 text-red-700',
                    sub_color: 'text-red-600',
                  },
                  {
                    label: 'DataForge',
                    sub: 'Ingest · Transform · Enrich',
                    color: 'bg-emerald-50 border-emerald-300 text-emerald-700',
                    sub_color: 'text-emerald-700',
                    highlight: true,
                  },
                  {
                    label: 'Refined Data',
                    sub: 'Clean, reliable, AI-ready',
                  ...
                  >
                    <div
                      className={`w-full sm:flex-1 rounded-xl border p-4 text-center ${item.color} ${item.highlight ? 'ring-2 ring-emerald-400/30' : ''}`}
                    >
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            >
              ...
              >
                ...
                <span className="text-emerald-600">entire data ecosystem.</span>
              </motion.h2>
              <motion.p
                variants={fadeUp}
                transition={{ duration: 0.55, ease: EASE }}
              ...
              >
                Legacy ETL tools were built for a batch world. DataForge is built for real time —
                continuous ingestion, instant transformation, and guaranteed delivery to every
                consumer in your stack, at any scale.
              </motion.p>
                  ...
                  {[
                    {
                      ...
                      sub: 'Primary destination for all ingested and transformed data',
                    },
                    {
                      label: 'Phoenix Insights',
                      sub: 'Delivers clean, enriched data for AI reasoning and analytics',
                    },
                    {
                      label: 'Cortexus',
                      sub: 'Supplies real-time context for autonomous agent execution',
                    },
                    {
                      label: 'Any downstream app',
                      sub: 'API-first delivery to any consumer in your stack',
                    },
                  ].map((item) => (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/60 mt-0.5">
                      Production-grade from the first pipeline
                    </p>
                  </div>
                </div>
      ...
      <section className="bg-gray-50">
        <div className="max-w-5xl mx-auto px-6 py-24">
          ...
          >
            ...
            >
              Watch DataForge connect and normalise sources — structured, unstructured, streaming or
              batch — into one governed pipeline ready for intelligence.
            </motion.p>
          </motion.div>
      ...
      <section className="bg-brand-navy">
        <div className="max-w-6xl mx-auto px-6 py-24 flex flex-col items-center text-center">
          ...
          >
            ...
            >
              Ready to Activate Your <span className="text-emerald-400">Data in Real Time?</span>
            </motion.h2>
            <motion.p
              variants={fadeUp}
              transition={{ duration: 0.6, ease: EASE }}
            ...
            >
              See DataForge ingest, transform, and deliver your data across your entire stack — in a
              live demo built around your architecture.
            </motion.p>
            <motion.div
              variants={fadeUp}
              transition={{ duration: 0.6, ease: EASE }}
