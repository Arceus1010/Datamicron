...
const CAPABILITIES = [
  {
    ...
    title: 'AI Agents',
    description:
      'Deploy intelligent agents that make decisions based on context, trigger actions automatically, and adapt over time through continuous learning.',
    points: [
  ...
  },
  {
    ...
    description:
      'Design and automate complex workflows that replace manual, repetitive processes with event-driven execution at enterprise scale.',
  ...
  },
  {
    ...
    description:
      'Integrate with internal and external systems to sync actions across CRM, ERP, and APIs — eliminating data silos and fragmented toolchains.',
  ...
  },
  {
    ...
    description:
      'Monitor outcomes, learn from feedback, and continuously optimise decisions — turning every execution into a training signal for the next.',
    points: [
...
const HOW_IT_WORKS = [
  {
    ...
    label: 'Trigger',
    description:
      'An event or insight is detected from your data or AI layer — a threshold breached, an anomaly flagged, a business signal received.',
  ...
  },
  {
    ...
    label: 'Decide',
    description:
      'The AI agent evaluates context, retrieves relevant memory, weighs options, and selects the optimal course of action.',
  ...
  },
  {
    ...
    label: 'Act',
    description:
      'Cortexus executes the decision across connected systems — updating records, triggering workflows, sending notifications, deploying changes.',
  ...
  },
  {
    ...
    label: 'Learn',
    description:
      'Outcomes feed back into the system. The agent refines its decision model, improving accuracy and efficiency with every execution cycle.',
...
const USE_CASES = [
  {
    ...
    items: [
      'Lead prioritisation + automated outreach',
  ...
  },
  {
    ...
    items: [
      'Demand changes → automated procurement',
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              >
                Turn Intelligence <span className="text-brand">into Action</span>
              ...
              >
                Cortexus is your enterprise execution engine, orchestrating AI agents, workflows,
                and systems to drive real-time, closed-loop operations.
              </motion.p>
            ...
            >
              <div className="bg-brand-navy rounded-2xl p-8 flex flex-col gap-6 border border-brand-navy-border">
                ...
                <p className="text-white/60 leading-relaxed text-sm">
                  Between insight and execution lies a chasm that costs organisations millions in
                  missed opportunities and operational drag. Cortexus bridges that gap — turning
                  signals into decisions and decisions into actions, automatically.
                </p>
      ...
      <section className="bg-white">
        <div className="max-w-4xl mx-auto px-6 py-24 text-center">
          ...
          >
            ...
            >
              An AI-powered <span className="text-brand">orchestration layer</span> that executes in
              real time.
            </motion.h2>
            <motion.p
              variants={fadeUp}
            ...
            >
              Cortexus deploys autonomous agents to execute workflows, coordinate systems, and
              continuously optimise operations — without waiting for human sign-off.
            </motion.p>
            <motion.div
              variants={fadeUp}
              transition={{ duration: 0.6, ease: EASE }}
        ...
        <div className="max-w-6xl mx-auto px-6 py-24">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              >
                Most automation platforms stop at workflows. Cortexus goes further — every execution
                becomes an input, every outcome refines the model, and the system grows more
                intelligent with each cycle.
              </motion.p>
              ...
              <div className="bg-brand-navy rounded-2xl p-6 border border-brand-navy-border flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-2.5">
                  {[
                    ...
                    'Compliance-ready execution framework',
      ...
      <section className="bg-gray-50">
        <div className="max-w-5xl mx-auto px-6 py-24">
          ...
          >
            ...
            >
              Watch Cortexus plan, reason and act — orchestrating workflows across systems and
              refining itself on the outcome of every execution.
            </motion.p>
          </motion.div>
      ...
      <section className="bg-brand-navy">
        <div className="max-w-6xl mx-auto px-6 py-24 flex flex-col items-center text-center">
          ...
          >
            ...
            >
              Ready to Automate <span className="text-brand">Intelligence at Scale?</span>
            </motion.h2>
            <motion.p
              variants={fadeUp}
              transition={{ duration: 0.6, ease: EASE }}
            ...
            >
              See Cortexus orchestrate agents, workflows, and systems in a live demo tailored to
              your enterprise.
            </motion.p>
            <motion.div
              variants={fadeUp}
