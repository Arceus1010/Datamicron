    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 1 1-3.586-3.586l5.653-4.655m5.8-5.8 3.516 3.516a2.248 2.248 0 0 1 0 3.18L16.5 15l-3.516-3.516m0 0-3.516-3.516a2.248 2.248 0 0 1 0-3.18L12 2.25l3.516 3.516"
        />
      </svg>
    ),
    imageSide: 'right' as const,
...
function ImagePlaceholder({ className = '' }: { className?: string }) {
  return (
    <div
      className={`w-full aspect-video rounded-sm bg-gray-100 border border-gray-200 flex items-center justify-center text-gray-300 ${className}`}
    >
      <svg
        className="w-10 h-10"
        fill="none"
  ...
  return (
    ...
    >
      ...
      <div className={`flex flex-col gap-5 ${isImageLeft ? 'lg:order-2' : 'lg:order-1'}`}>
        <div
          className={`w-11 h-11 rounded-lg flex items-center justify-center shrink-0 ${dark ? 'bg-brand/20 text-brand' : 'bg-brand-light text-brand'}`}
        >
          {icon}
        </div>
        <h3
          className={`text-xl font-bold leading-snug tracking-tight ${dark ? 'text-white' : 'text-gray-900'}`}
        >
          {title}
        </h3>
        <ul className="grid sm:grid-cols-2 gap-x-4 gap-y-1.5">
          {items.map((item) => (
            <li
              key={item}
              className={`flex items-start gap-2 text-sm ${dark ? 'text-white/70' : 'text-gray-500'}`}
            >
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              >
                We provide strategic consulting and end-to-end implementation services that guide
                your organisation through every step of its data-driven transformation.
              </motion.p>
      ...
      <section id="consulting" className="bg-gray-50">
        <div className="max-w-6xl mx-auto px-6 py-24">
          ...
          >
            ...
            >
              At Datamicron, we understand that successful integration of AI, Machine Learning, and
              Big Data requires more than just cutting-edge technology — it demands a strategic and
              thoughtful approach. Our consulting services are designed to guide your organisation
              tailored every step of this transformative journey.
            </motion.p>
          </motion.div>
      ...
      <section className="bg-brand-navy">
        <div className="max-w-6xl mx-auto px-6 py-24">
          ...
          >
            ...
            >
              Our Implementation Services bring your strategic plans to life, delivering practical,
              efficient, and effective solutions that leverage the latest advancements in AI,
        ...
        <div className="max-w-6xl mx-auto px-6 py-24 flex flex-col items-center text-center">
          ...
          >
            ...
            <motion.p
              ...
              className="text-lg text-gray-500 leading-relaxed"
            >
              See how Datamicron's services can transform your organisation into a data-driven
              enterprise. Talk to our team today.
            </motion.p>
