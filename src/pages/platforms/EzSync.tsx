...
const CAPABILITIES = [
  {
    ...
    description:
      'Describe the integration you want and let EzSync wire it up — no bespoke plumbing per endpoint.',
  },
  {
    title: 'Consume & Expose APIs',
    description:
      'Pull from the services you depend on and publish your own, managed from the same place.',
  },
  {
    title: 'Secure Data Transfer',
    description: 'Extensive datasets moved between systems and sources securely, end to end.',
  },
  {
    title: 'Data Orchestration',
    description:
      'Coordinate multi-step movement across systems so data lands where it is needed, in order.',
  },
  {
    title: 'Big Data Pipelines',
    description: 'Feed analytics platforms at volume without hand-built extraction jobs.',
  },
  {
    title: 'Cross-System Sync',
    description: 'Keep records aligned across the applications and stores that hold them.',
  },
]
    ...
    <div className="relative w-full max-w-lg">
      ...
      >
          ...
          {ENDPOINTS.map((endpoint, i) => (
            ...
            >
              ...
              <div className="relative flex-1 h-1.5 rounded-full bg-white/8 overflow-hidden">
                {reduceMotion ? (
                  <span className="absolute inset-y-0 left-0 w-1/3 rounded-full bg-brand/60" />
                ) : (
                  <motion.span
        ...
        <div className="pt-1 flex items-center justify-between">
          <span className="text-xs text-white/60">Records moved today</span>
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              >
                Simplifying API integration and data orchestration — connect, consume and expose
                APIs with declarative ease, and move extensive datasets between systems securely.
              </motion.p>
      ...
      <section id="why" className="bg-white">
        <div className="max-w-6xl mx-auto px-6 py-24">
          ...
          >
            ...
            >
              One central tool for API connectivity and data movement — so integration work stops
              being written from scratch for every system you add.
            </motion.p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-24">
          ...
          >
            ...
            <motion.p
              ...
              className="text-xl text-gray-500 leading-relaxed"
            >
              From a single API definition to orchestrated movement across every system that holds
              your data.
            </motion.p>
          </motion.div>
      ...
      <section className="bg-brand-navy">
        <div className="max-w-5xl mx-auto px-6 py-24">
          ...
          >
            ...
            >
              Watch an integration take shape in EzSync — an API declared, a dataset moved between
              systems and analytics fed without hand-built pipelines.
            </motion.p>
          </motion.div>
